...
class LoginViewModel @Inject constructor(
    ...
    fun login() {
        ...
        viewModelScope.launch {
            val simulatedUserId = "test_user_id" // Or any other placeholder ID

            Logger.w("LOGIN BYPASSED: Using simulated user ID: $simulatedUserId")

            _userId.postValue(Event(simulatedUserId))
            userPreferences.saveUserId(simulatedUserId)
